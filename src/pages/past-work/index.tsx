...
const DESCRIPTION =
  "Fifteen years of shipping product, code, and design — as a founder, a sole developer, and a product leader. Paintball Vault, PangoBooks, Reverb, Studio Three, Crowler, Blitz Lake. A selection since 2010.";
      ...
      <main id="main" className="container">
        <header className={styles.header}>
          ...
          <p className={classNames("lede", styles.lede)}>
            ...
            founder, a sole developer, and a product leader. A selection since
            2010.
          </p>
        </header>

        <section className={styles.rows} aria-label="Selected work">
          {WORK_ROWS.map((row) => (
            <article
              key={row.name}
