  ...
  components: [
    ...
    },
    {
      ...
      data: {
        ...
        description:
          "In the vast world of craft beers, finding that perfect brew can be a daunting task. Enter Crowler, an app I proudly founded to transform the way beer enthusiasts discover their next favorite pint.<br /><br />At the core of Crowler's innovation is its state-of-the-art image recognition technology. Simply point your device at a beer label in-store, and Crowler instantly identifies it. But it doesn't stop there. Once recognized, the app presents you with ratings from leading beer connoisseurs and platforms, ensuring that you're making an informed choice.",
      },
    },
    {
      type: "gallery",
